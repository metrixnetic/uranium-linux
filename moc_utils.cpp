...
QT_MOC_LITERAL(1, 6, 13), // "fromUserInput"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 9) // "userInput"

    },
    "Utils\0fromUserInput\0\0userInput"
};
...
void Utils::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { QUrl _r = _t->fromUserInput((*reinterpret_cast< const QString(*)>(_a[1])));
